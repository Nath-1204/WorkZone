...
import { updateFileData } from "../../../redux/ActionCreater/FileFoldersActionCreater";

const Header = ({ fileName, fileData, fileId, prevFileData }) => {

    const navigate = useNavigate();
    const dispatch = useDispatch();

    return(
        <nav className="navbar navbar-expand-lg mt-1 pb-0 navbar-light bg-white shadow-sm">
